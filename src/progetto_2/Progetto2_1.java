...
public class Progetto2_1 {
    public static final String DB_NAME = "Database.db";

    private static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Federico Chieffa\\Desktop\\"+DB_NAME;

    private static final String REGION = "Region",COUNTRY = "Country",ITEM_TYPE = " Item_type", SALES_CHANNEL = "Sales_channel", ORDER_PRIORITY = "Order Priority", ORDER_DATE= "Order Date",
            ORDER_ID= "Order ID", SHIP_DATE= "Ship Date", UNITS_SOLD= "Units Sold", UNIT_PRICE= "Unit Price", UNIT_COST= "Unit Cost",TOTAL_REVENUE = "Total Revenue" ,TOTAL_COST = "Total Cost" ,
